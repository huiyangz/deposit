...
public interface IMbProdIntBcc {
    ...
    /** remove 根据主键: 产品类型、事件类型、利息分类、利率类型、法人 **/
    int removeByPrimaryKey(String prodType, String eventType, String intClass, String intType, String company);
    ...
    /** find 根据主键: 产品类型、事件类型、利息分类、利率类型、法人 **/
    MbProdIntEO findByPrimaryKey(String prodType, String eventType, String intClass, String intType, String company);

    /**  根据主键: 产品类型、事件类型、利息分类、利率类型、法人执行更新记录操作，仅更新入参com.dcits.deposit.facade.eo.MbProdIntEO中不为空的属性字段 **/
    int modifyByPrimaryKeySelective(MbProdIntEO eo);

    /** modify 根据主键: 产品类型、事件类型、利息分类、利率类型、法人 **/
