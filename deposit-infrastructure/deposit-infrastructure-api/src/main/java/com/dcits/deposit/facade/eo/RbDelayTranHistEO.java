...
public class RbDelayTranHistEO {
    /** 序号 */
    @NotNull
    ...
    /** 单位结算卡转账标志 */
    private IndividualFlag settleCardFlag;
    /** 币种 */
    private AcctCcy ccy;
    /** 到账方式 */
    ...
    public IndividualFlag getSettleCardFlag() {
        return settleCardFlag;
    }

    public void setSettleCardFlag(IndividualFlag settleCardFlag) {
    ...
    public AcctCcy getInnerAcctCcy() {
        return innerAcctCcy;
    }

    public void setInnerAcctCcy(AcctCcy innerAcctCcy) {
