...
public class RbAcctBalanceEO {
    ...
    /** 上次余额更新日期 */
    private java.util.Date lastBalUpdDate;
    /** 最后修改日期 */
    ...
    public java.util.Date getLastBalUpdDate() {
        return lastBalUpdDate;
    }

    public void setLastBalUpdDate(java.util.Date lastBalUpdDate) {
