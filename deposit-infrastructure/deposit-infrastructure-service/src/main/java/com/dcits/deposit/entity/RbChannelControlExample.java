...
public class RbChannelControlExample {
    protected String orderByClause;
    protected boolean distinct;
    protected List<Criteria> oredCriteria;

    public RbChannelControlExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andControlSeqNoEqualTo(String value) {
            addCriterion("CONTROL_SEQ_NO =", value, "controlSeqNo");
