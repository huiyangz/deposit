...
public class RbLimitSumInfoBasisCpnt implements IRbLimitSumInfoBcc {
    ...
    public int removeByPrimaryKey(String clientNo, String limitSceneNo, String checkObjVal) {
        return rbLimitSumInfoMapper.deleteByPrimaryKey(clientNo, limitSceneNo, checkObjVal);
    }
    ...
    @Override
    public RbLimitSumInfoEO findByPrimaryKey(String clientNo, String limitSceneNo, String checkObjVal) {
        return RbLimitSumInfoValueUtil.entityToEo(rbLimitSumInfoMapper.selectByPrimaryKey(clientNo, limitSceneNo, checkObjVal));
    }
