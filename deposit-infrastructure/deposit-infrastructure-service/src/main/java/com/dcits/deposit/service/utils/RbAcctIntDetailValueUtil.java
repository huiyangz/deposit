...
public final class RbAcctIntDetailValueUtil {
    private RbAcctIntDetailValueUtil() {
    }

    public static RbAcctIntDetailEO entityToEo(RbAcctIntDetail entity) {
        if (entity == null) {
            return null;
        }
        RbAcctIntDetailEO eo = new RbAcctIntDetailEO();
        ...
        eo.setLastPreAccrualDate(entity.getLastPreAccrualDate());
        eo.setIntUpdLastDate(entity.getIntUpdLastDate());
        return eo;
    }

    public static RbAcctIntDetail eoToEntity(RbAcctIntDetailEO eo) {
        if (eo == null) {
            return null;
        }
        RbAcctIntDetail entity = new RbAcctIntDetail();
        ...
        entity.setLastPreAccrualDate(eo.getLastPreAccrualDate());
        entity.setIntUpdLastDate(eo.getIntUpdLastDate());
        return entity;
    }

    public static RbAcctIntDetailExample eoToEntityExample(RbAcctIntDetailEO eo) {
        if (eo == null) {
            return null;
        }
        RbAcctIntDetailExample example = new RbAcctIntDetailExample();
        RbAcctIntDetailExample.Criteria criteria = example.createCriteria();
        ...
        if (eo.getLastPreAccrualDate() != null) criteria.andLastPreAccrualDateEqualTo(eo.getLastPreAccrualDate());
        if (eo.getIntUpdLastDate() != null) criteria.andIntUpdLastDateEqualTo(eo.getIntUpdLastDate());
        return example;
    }
}