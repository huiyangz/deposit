...
public class FmClientCopy {
    ...
    /** 法定代表人身份证件类型 */
    private String repDocumentType;
    /** 法定代表人名称 */
    private String legalRep;
    /** 法人代表证件到期日期 */
    private Date repExpiryDate;
    /** 客户细分类型 */
    ...
    public String getRepDocumentType() {
        return repDocumentType;
    }

    public void setRepDocumentType(String repDocumentType) {
    ...
    public Date getRepExpiryDate() {
        return repExpiryDate;
    }

    public void setRepExpiryDate(Date repExpiryDate) {
    ...
    public void setTaxResidentFlag(String taxResidentFlag) {
