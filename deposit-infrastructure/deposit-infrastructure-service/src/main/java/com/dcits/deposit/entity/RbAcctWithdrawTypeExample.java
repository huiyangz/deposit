...
public class RbAcctWithdrawTypeExample {
    protected String orderByClause;
    protected boolean distinct;
    protected List<Criteria> oredCriteria;

    public RbAcctWithdrawTypeExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andWithdrawKeyEqualTo(String value) {
            addCriterion("WITHDRAW_KEY =", value, "withdrawKey");
