...
public class RbAcctIntDetail {
    ...
    /** 上一预计提日 */
    private Date lastPreAccrualDate;
    /** 上日已付利息及计提备份日期 */
    private Date intUpdLastDate;
    ...
    public Date getLastPreAccrualDate() {
        return lastPreAccrualDate;
    }

    public void setLastPreAccrualDate(Date lastPreAccrualDate) {
        this.lastPreAccrualDate = lastPreAccrualDate;
    }

    public Date getIntUpdLastDate() {
        return intUpdLastDate;
    }

    public void setIntUpdLastDate(Date intUpdLastDate) {
